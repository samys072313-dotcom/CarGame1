...
function setup(){
   ...
   road2.addImage("img", road2img);
    ...
    wallInv=createSprite(470,25,5,height+1000);
    wall2Inv=createSprite(1110,25,5,height+1000);
...
function draw(){
   ...
   let levelupPlayed = false;
    ...
    if (score >= 100 && !levelUpPlayed) {
    levelup.play();
    levelUpPlayed = true; // This prevents the code from running again
    }
    if (score >= 100){
    blocksGroup.setVelocityYEach(20);
    conesGroup.setVelocityYEach(20);
    starsGroup.setVelocityYEach(20);
